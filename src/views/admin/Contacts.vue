<template>
  <div>
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <h2 class="text-xl font-bold text-gray-800 sm:text-2xl">Customer Enquiries</h2>
      <div class="flex w-full items-center gap-2 sm:w-auto">
        <select
          v-model="statusFilter"
          class="w-full text-sm border border-gray-300 rounded-lg px-3 py-2 bg-white focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none sm:w-auto"
    ...
    <div class="mb-5 flex gap-1 overflow-x-auto rounded-lg bg-gray-100 p-1">
      <button
        ...
        :key="tab.key"
        :class="[
          'shrink-0 whitespace-nowrap px-4 py-2 rounded-md text-sm font-medium transition-all',
          activeTab === tab.key
    ...
    <Teleport to="body">
      ...
      >
        ...
        <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[85vh] overflow-y-auto z-10">
          <!-- Header -->
          <div class="sticky top-0 bg-white border-b border-gray-200 px-4 py-4 sm:px-6 flex justify-between items-center rounded-t-xl">
          ...
          <!-- Footer actions -->
          <div class="sticky bottom-0 bg-white border-t border-gray-200 px-4 py-4 sm:px-6 flex flex-col gap-3 rounded-b-xl sm:flex-row sm:items-center sm:justify-between">
            <button
            ...
            <div class="flex gap-3">
              <a
                ...
                class="w-full px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 transition-colors text-center sm:w-auto"
              >
                Reply via Email
              </a>
            </div>
