<template>
  <div class="space-y-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <h2 class="text-xl text-gray-800 font-bold sm:text-2xl">Homepage Content Settings</h2>
      <button @click="saveSettings" class="inline-flex items-center justify-center bg-black hover:bg-brand text-white font-medium px-5 py-2.5 rounded shadow-sm transition-colors">
        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
        Save All Changes
      </button>
    </div>
    
    <div class="bg-white shadow-sm border border-gray-200 rounded-lg p-5 sm:p-8">
