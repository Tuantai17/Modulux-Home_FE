<template>
  <div class="space-y-6">
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <h2 class="text-xl font-bold text-gray-800 sm:text-2xl">Manage Hero Banners</h2>
      <button
        @click="openModal()"
    ...
    <div v-if="showModal" class="fixed inset-0 z-50 flex items-end justify-center bg-black/50 px-4 sm:items-center">
      <div class="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-lg bg-white p-5 sm:p-6 shadow-xl">
