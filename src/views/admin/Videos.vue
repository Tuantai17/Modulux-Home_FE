<template>
  <div class="space-y-6">
    <div class="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
      ...
      <div class="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
        <select
          ...
          class="w-full rounded border border-gray-300 px-3 py-2 text-sm text-gray-700 outline-none focus:ring-1 focus:ring-black sm:w-auto"
          @change="fetchVideos"
        >
    ...
    <div v-if="showModal" class="fixed inset-0 z-50 flex items-start justify-center bg-black/50 px-3 py-3 sm:items-center sm:px-4">
      <div class="max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-lg bg-white p-5 sm:p-6 shadow-xl">
