<template>
  <div class="space-y-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <h2 class="text-xl font-bold text-gray-800 sm:text-2xl">Manage Static Pages</h2>
    ...
    <div v-if="showModal" class="fixed inset-0 bg-black/50 flex items-start justify-center z-50 p-3 sm:items-center sm:p-4">
      <div class="bg-white rounded-xl w-full max-w-5xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden">
        
        <!-- Modal Header with Tabs -->
        <div class="px-4 py-4 border-b border-gray-100 flex flex-col gap-3 bg-gray-50 sm:flex-row sm:items-center sm:justify-between sm:px-6">
          <div>
            <h3 class="text-lg font-bold text-gray-900">{{ isEditing ? 'Edit Page: ' + form.title : 'Add New Page' }}</h3>
          </div>
          <div class="flex flex-wrap bg-gray-200 p-1 rounded-lg">
            <button 
        ...
        <div class="flex-1 overflow-y-auto p-4 sm:p-6">
          ...
          <div v-if="activeTab === 'basic'" class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6 pt-4 border-t border-gray-50 sm:grid-cols-2">
              <div class="space-y-1">
          ...
          <div v-else-if="activeTab === 'sections'" class="space-y-8">
            ...
            <div v-for="(sec, idx) in form.sections" :key="sec.id || idx" class="bg-gray-50 border border-gray-200 rounded-xl p-5 relative group transition-all hover:border-gray-300">
              <div class="absolute right-4 top-4 block">
        ...
        <!-- Sticky Footer -->
        <div class="px-4 py-4 border-t border-gray-100 flex flex-col-reverse gap-3 bg-gray-50 sm:flex-row sm:justify-end sm:px-6">
