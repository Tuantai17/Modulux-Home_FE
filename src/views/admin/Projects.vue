<template>
  <div class="space-y-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <h2 class="text-xl text-gray-800 font-bold sm:text-2xl">Manage Your Modular House Portfolio</h2>
      <button @click="openModal()" class="inline-flex items-center justify-center rounded bg-black px-5 py-2.5 text-white font-medium shadow-sm transition-colors hover:bg-brand">
    ...
    <!-- Modal Form -->
    <div v-if="showModal" class="fixed inset-0 z-50 flex items-start justify-center p-3 bg-black/60 backdrop-blur-sm sm:items-center sm:p-4">
      <div class="bg-white rounded-lg shadow-2xl w-full max-w-4xl max-h-[92vh] overflow-y-auto">
        ...
        <form @submit.prevent="saveProject" class="p-4 space-y-5 sm:p-6">
          <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
            ...
            <div v-if="isEditing" class="col-span-1 sm:col-span-2">
              ...
              <!-- Add New Image -->
              <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-4 flex flex-col gap-4 lg:flex-row lg:items-end">
                <div class="flex-grow">
                ...
                <div>
                  ...
                  <input v-model="newImageOrder" type="number" class="w-full lg:w-20 border border-gray-300 rounded px-3 py-2 text-gray-900 focus:ring-1 focus:ring-black focus:border-black outline-none text-sm">
                </div>
                <div class="flex flex-wrap gap-3 px-2 py-2">
              ...
              <div v-if="form.images && form.images.length > 0" class="space-y-3">
                <div v-for="img in form.images" :key="img.id" class="flex flex-col gap-4 bg-white border border-gray-200 p-3 rounded-lg shadow-sm sm:flex-row sm:items-center">
          ...
          <div class="pt-6 mt-8 flex flex-col-reverse gap-3 border-t border-gray-100 sm:flex-row sm:justify-end">
